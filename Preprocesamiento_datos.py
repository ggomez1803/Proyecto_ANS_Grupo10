...
# Cargar datos 
df_donantes = pd.read_csv('./Archivos_Cliente/Base_donantes.csv', encoding='latin-1')
...
# Guardar datos
df_donantes.to_csv('./Archivos_Cliente/Base_donantes_preprocesada.csv', index=False, encoding='latin-1')
...
# Cargar datos
df_transacciones = pd.read_csv('./Archivos_Cliente/Transacciones_Individuales.csv', sep=';', encoding='latin-1')
...
# Guardar datos
df_transacciones.to_csv('./Archivos_Cliente/Transacciones_Individuales_preprocesada.csv', index=False, encoding='latin-1')

# Imprimir mensaje de finalización
print('Proceso finalizado para transacciones individuales')

#### Preprocesamiento Transacciones Juridicos ####
# Cargar datos
df_transacciones = pd.read_csv('./Archivos_Cliente/Transacciones_jurídicos.csv', encoding='latin-1')
...
df_transacciones = pr_transacciones.ajustar_nombre_y_tipo_columnas('Tipo de registro', 'FK_CD_Registro', 'str')
df_transacciones = pr_transacciones.ajustar_nombre_y_tipo_columnas('Canal de la Campaña', 'FK_CD_Canal_campana', 'str')
df_transacciones = pr_transacciones.ajustar_nombre_y_tipo_columnas('Sub Canal Captación', 'FK_CD_Sub_Canal_Captacion', 'str')

# Guardar datos
df_transacciones.to_csv('./Archivos_Cliente/Transacciones_jurídicos_preprocesada.csv', index=False, encoding='latin-1')

# Imprimir mensaje de finalización
print('Proceso finalizado para transacciones jurídicos')

#### Preprocesamiento Donantes Jurídicos ####
# Cargar datos
df_cuentas = pd.read_csv('./Archivos_Cliente/Base_cuentas.csv', encoding='latin-1')

# Definir si se quiere retornar o no los datos con errores
return_errors = False

# Crear objeto de la clase
pr_cuentas = Funciones_Preprocesamiento.Preprocesamiento_Donantes(df_cuentas)

# Corregir columnas de fechas
df_cuentas = pr_cuentas.corregir_fechas('Fecha de Captación', 'DT_Captacion', return_errors)
df_cuentas = pr_cuentas.corregir_fechas('Fecha de Última Donación Global', 'DT_Ultima_Donacion', return_errors)

# Corregir nombres y tipos de datos
df_cuentas = pr_cuentas.ajustar_nombre_y_tipo_columnas('PSN', 'ID_Donante', 'int')
df_cuentas = pr_cuentas.ajustar_nombre_y_tipo_columnas('Campaña Inicial: Nombre', 'FK_ID_Campana', 'str')
df_cuentas = pr_cuentas.ajustar_nombre_y_tipo_columnas('Donante Activo', 'CD_Donante_Activo', 'bool')
df_cuentas = pr_cuentas.ajustar_nombre_y_tipo_columnas('Tipo de registro de cuenta', 'CD_Tipo_Registro', 'str')
df_cuentas = pr_cuentas.ajustar_nombre_y_tipo_columnas('Segmento RFM', 'FK_ID_Segmento_RFM', 'str')
df_cuentas = pr_cuentas.ajustar_nombre_y_tipo_columnas('Cantidad Cuotas Pagadas Global', 'VL_Cuotas_Pagadas', 'int')
df_cuentas = pr_cuentas.ajustar_nombre_y_tipo_columnas('Cantidad Cuotas No Pagadas Global', 'VL_Cuotas_No_Pagadas', 'int')

# Guardar datos
df_cuentas.to_csv('./Archivos_Cliente/Base_cuentas_preprocesada.csv', index=False, encoding='latin-1')

# Imprimir mensaje de finalización
print('Proceso finalizado para base de cuentas')

#### Preprocesamiento Cancelaciones ####
# Cargar datos
df_cancelaciones = pd.read_csv('./Archivos_Cliente/Cancelaciones.csv', encoding='latin-1')
...
# Guardar datos
df_cancelaciones.to_csv('./Archivos_Cliente/Cancelaciones_preprocesada.csv', index=False, encoding='latin-1')
